...
**Pergunta:** Quais seções você considera essenciais na página?

**Resposta:** Uma área inicial chamativa, uma seção explicando quem somos e um formulário de contato.

## 4. NAVEGAÇÃO

**Pergunta:** Você deseja navegação entre as seções da página?

**Resposta:** Sim, queremos um menu simples no topo para facilitar a navegação.
...
**Pergunta:** O site precisa funcionar bem em celulares e tablets?

**Resposta:** Sim. A maioria dos acessos será feita por dispositivos móveis.
...
**Pergunta:** Existe algum critério de qualidade esperado para o projeto?

**Resposta:** O site deve funcionar corretamente e não apresentar erros básicos de código.

## 10. EVOLUÇÃO DO PROJETO

**Pergunta:** Esse projeto pode receber novas funcionalidades no futuro?

**Resposta:** Sim. Novas seções e melhorias podem ser adicionadas conforme a necessidade.
...
Os requisitos acima foram convertidos em Issues no GitHub e planejados no Kanban do projeto.
